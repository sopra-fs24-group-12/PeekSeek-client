...
type ContainerSize = "waiting" | "landing" | "small" | "medium" | "large" |"voting" | "game" | "policy" | "gamesummary";
...
const BaseContainer: React.FC<BaseContainerProps> = ({ className, children, size, initialSize = "large" }) => {
  ...
  const containerClasses = {
    ...
    voting: "w-full md:w-[95%] lg:w-[95%] xl:w-[95%] h-full md:h-[95vh] lg:h-[95vh] xl:h-[95vh] shadow-lg overflow-y-auto",
    ...
    gamesummary: "w-full md:w-[95%] lg:w-[95%] xl:w-[95%] h-full md:h-[95vh] lg:h-[95vh] xl:h-[95vh] shadow-lg overflow-y-auto",
  };
      ...
      >
        <CardBody
          className={`flex-grow mb-2 ${
            containerSize === "gamesummary"
              ? "overflow-x-hidden"
              : containerSize !== "voting"
                ? "overflow-hidden"
                : windowWidth <= 1024
                  ? "overflow-x-hidden"
                  : "overflow-hidden"
